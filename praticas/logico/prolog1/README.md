...
7. Em Prolog, listas são tipos de dados nativos. Como em Python, uma lista se representa com colchetes. Existem também vários predicados pré-definidos que manipulam listas. Teste as consultas abaixo com os predicados `member`, `length` e `nextto`:
